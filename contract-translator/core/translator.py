"""
SmartEval Contract Translator - Main orchestrator class
"""
...
# minimal stub so the module loads when the agentics package is absent.
try:
...
class IBMAgenticContractTranslator:
    ...
    def translate_contract_streaming(
        ...
        if use_agentic_pipeline:
            print("SMARTEVAL CONTRACT TRANSLATOR (STREAMING - Agent/Task Pipeline)")
        else:
            print(
                "SMARTEVAL CONTRACT TRANSLATOR (STREAMING - Legacy Program Pipeline)"
            )
        print("=" * 70)
    ...
    def translate_contract(
        ...
        print("\n" + "=" * 70)
        if use_agentic_pipeline:
            print("SMARTEVAL CONTRACT TRANSLATOR (Agent/Task Pipeline)")
        else:
            print("SMARTEVAL CONTRACT TRANSLATOR (Legacy Program Pipeline)")
        print("=" * 70)
...
"""
        ...
        readme = f"""# SmartEval Contract Translation
...
---
*Generated by SmartEval Pipeline*
